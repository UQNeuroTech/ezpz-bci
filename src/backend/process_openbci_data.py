...
def convert_to_mne(board_id, name, save_name, save_path, samples, save=True, show_ui=True, classify=False):
...
if __name__ == "__main__":
    ...
    convert_to_mne(board_id, name, name, "../../data", samples, save=True, show_ui=True)